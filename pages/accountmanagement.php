																...
																<tbody>
																	<tr>
																		...
																		<td width="100%" valign="middle">
																			'.$account_statusOver.'';
																		$main_content .= '
																			<small><br>Não Há Vip Neste Servidor!</font></small>';
																		$main_content .= '
																		</td>
																		<td>
							...
							<table class="HintBox" >
								<tr>
									<td>
										...
										<p><b>Registar Conta Sua conta não está registrada!</b></p>
										<p>Você precisa clicar aqui para registrar sua conta e receber sua chave de recuperação. Por favor, tome cuidado com sua chave de recuperação.</p>
										<p>Caso você tenha perdido sua Chave de Recuperação, você pode solicitar a nova chave de recuperação para sua conta novamente.</p>
									</td>
								<tr>
							</table>
						</div>
							...
							<div class="Message">
								...
								<table class="HintBox">
									<tbody>
										<tr>
											<td>
												<p><b>Novo gerenciamento de contas</b></p>
		...
		{ 
			...
			{	
				...
				if(empty($newchar_errors))
				{
					...
					$char_to_copy->setPosX(1095);
					$char_to_copy->setPosY(1063);
