...
$town_array = $towns_list[2];
$town = $config['site']['newchar_towns'][2];
$voc = array(); // if empty, Rook Sample will be used
$voc[1] = 'Master Sorcerer';
$voc[2] = 'Elder Druid';
$voc[3] = 'Sniper';
$voc[4] = 'Warrior';
$voc[5] = 'Knight';
...
if(!$hardcore)
	$main_content .= '<td align="center" valign="top"><b><script>CreateFilterOption(\'server_pvp_type\', \'hardcore\', \'Open PvP\')</script></b>&nbsp;&nbsp;<br/><br/></td>';
