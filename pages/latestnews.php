											...
											<tr class="Table" style="background-color: #d4c0a1;">
												<td style="width: 800; border: 1px; border-style: solid; border-color: #FAF0D7;">
													<div class="NewsHeadline">
														<div class="NewsHeadlineBackground" style="background-image:url(' . $layout_name . '/images/news/newsheadline_background_black.gif)">
															<table border="0">
																<tr>
																	<td style="text-align: center; font-weight: bold; width: 700px;">
																		<font color="white">Bem Vindo ao The Onlyone Server</font>
																	</td>
																</tr>
															</table>
														</div>
...
///End Queries ///
											$main_content .= ' 
<tr bgcolor='. $config['site']['lightborder'] .'><td><center>Não se esqueça de visitar a pagina <b>library</b> e conhecer tudo sobre o server, Diverta-se.</center></td></tr>             
													<tr bgcolor='. $config['site']['lightborder'] .'><td><center>Atualmente, o melhor jogador é: <a href="index.php?subtopic=characters&name='.urlencode($query['name']).'"> '.$query['name'].'</a> ('.urlencode($query['level']).'). Parabéns!</center></td></tr>
    <table border=0 cellpadding=0 cellspacing=1 width=100%>   
    <tr bgcolor='. $config['site']['lightborder'] .'><td><center><b>Contas</b> na database: '.$accounts[0].'</center></td>
    <td><center><b>Jogadores</b> na database: '.$players[0].'</center></td>
    <tr bgcolor='. $config['site']['lightborder'] .'><td><center><b>Banidos</b>: '.$banned[0].'</center></td>
    <td><center><b>Guilds</b>: '.$guilds[0].'</center></td>';
												$main_content .= '
																			</tr>
																		</table>
																	</td>
...
$news_content .= '
	<div id="NewsTicker" class="Box">
    	...
    	<div class="BorderTitleText" style="background-image: url('.$layout_name.'/images/content/title-background-blue.gif);"></div>
        ...
        foreach($featured_article as $featured)
        {
			...
			$news_content .= '
				<div id="FeaturedArticle" class="Box">
					...
					<div class="Corner-tr" style="background-image:url('.$layout_name.'/images/content/corner-tr.gif);"></div>
					<div class="Border_1" style="background-image:url('.$layout_name.'/images/content/border-1.gif);"></div>
					<div class="BorderTitleText" style="background-image:url('.$layout_name.'/images/news/newsheadline_background_black.gif);"></div>
...
<hr/>';
    ...
    if(isset($last_threads[0]))
    {
        ...
        $main_content .= '<h3><center>Nenhuma notícia no momento.</center></h3>';