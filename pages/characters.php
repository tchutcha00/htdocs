	...
	<div class="CaptionContainer">
		<div class="CaptionInnerContainer">
			...
			*/
			...
			// Equip
			$number_of_items = 1;
						$items = simplexml_load_file($config['site']['server_path'].'C:/Otserv/data/items/items.xml') or die('<b>Could not load items!</b>');
            ...
            $itemList[(int)$v['id']] = ucwords(strtolower($v['name']));
				...
				$citizen = $player->getStorage(10001) && $player->getStorage(10002);
				$hunter = $player->getStorage(10003) && $player->getStorage(10004);
				$knight = $player->getStorage(10005) && $player->getStorage(10006);
				$mage = $player->getStorage(10007) && $player->getStorage(10008);
				$summoner = $player->getStorage(10009) && $player->getStorage(10010);
				$barbarian = $player->getStorage(10011) && $player->getStorage(10012);
				$druid = $player->getStorage(10013) && $player->getStorage(10014);
				$nobleman = $player->getStorage(10015) && $player->getStorage(10016);
				$oriental = $player->getStorage(10017) && $player->getStorage(10018);
				$warrior = $player->getStorage(10019) && $player->getStorage(10020);
				$wizard = $player->getStorage(10021) && $player->getStorage(10022);
				$assassin = $player->getStorage(10023) && $player->getStorage(10024);
				$beggar = $player->getStorage(10025) && $player->getStorage(10026);
				$pirate = $player->getStorage(10027) && $player->getStorage(10028);
				$shaman = $player->getStorage(10029) && $player->getStorage(10030);
				$norseman = $player->getStorage(10031) && $player->getStorage(10032);
				$jester = $player->getStorage(10033) && $player->getStorage(10034);
				$demonhunter = $player->getStorage(10035) && $player->getStorage(10036);
				$nightmare = $player->getStorage(10037) && $player->getStorage(10038);
				$brotherhood = $player->getStorage(10039) && $player->getStorage(10040);
				$yalaharian = $player->getStorage(10041) && $player->getStorage(10042);
				$warmaster = $player->getStorage(10043) && $player->getStorage(10044);
				$wayfarer = $player->getStorage(10045) && $player->getStorage(10046);
				...
				if(!$player->getHideChar()) 
				{
					...
					<br><br>
					<image src="/animatedOutfits1099/animoutfit.php?id='.$player->getLookType().'&addons='.$player->getLookAddons().'&head='.$player->getLookHead().'&body='.$player->getLookBody().'&legs='.$player->getLookLegs().'&feet='.$player->getLookFeet().'" width="64" height="64" style="width: 64px; height: 64px; position: absolute; background-position: 0 0; background-repeat: no-repeat; left: 100px; margin-top: -10px;"/>
					...
					<img style="margin-bottom: 5px;margin-left: 7px;margin-top: 3px;margin: 3px;width: 47px;height: 47px;background: rgba(155, 155, 155, 0.53);border-radius: 5px;border: 3.5px solid #434040;box-shadow: inset 0px 0px 10px rgba(0,0,0,0.5);" src="images/bg.gif" width="234" height="234">
					</td>
					</tr>
					</span>';
				}
