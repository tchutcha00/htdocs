...
$config['site']['serverPath'] = "C:/Otserv-otx/";
$config['site']['useServerConfigCache'] = false;
$config['site']['worlds'] = array(0 => 'Theonlyone');
$towns_list[0] = array(1 => 'Theonlyone City');

$config['site']['outfit_images_url'] = '/animatedOutfits1099/animoutfit.php';
...
$config['pagSeguro']['databasePass'] = 'lucas2324';		## PASSWORD
...
$config['site']['quests'] = array('Pickrod' => 8749);
$config['site']['show_skills_info'] = true;
$config['site']['showVipList'] = true;
